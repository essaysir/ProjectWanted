...
<div id="resumeList">
	...
	<div class="title">
		...
		<c:forEach var="map" items="${requestScope.resumeList}">
		<div id='resumeBox' style='color: #999999;'>
			<div style='margin: 0 20px;'>
				<h5>${map.subject}</h5>
				<p style='font-weight: bold;'>${map.complete_date}</p>
			</div>	
			<div id='status'>
				<div class='es_dropdown'>
					<button class='es_dropbtn' onclick='myFunction(${map.resume_code})'><i class='fa-solid fa-ellipsis-vertical'></i></button>
