...
<style type="text/css">
	...
	<section class="topBanner" style="height: 430px;">
		...
		<div style="margin: 40px auto; width: 350px">
			<button class="resumeHome2_button1" type="button" style="background-color: #FFF; color: #3366FF; width: 150px !important;"><span>이력서 관리</span></button>
			<button class="resumeHome2_button2" type="button" style="background-color: #3366FF; color: #FFF;"><span>새 이력서 작성</span></button>
		</div>
	</section>
