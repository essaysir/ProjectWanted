...
public interface InterPostDAO {
	...
	// 검색필터를 거친 공고리스트 불러오기
	List<Map<String, String>> getPostListWithFilters(List<String> job_code, List<String> duty_code, List<String> region_detail_code, List<String> career, List<String> tech_code);
